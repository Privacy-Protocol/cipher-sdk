 ...
 */
interface IGovernorConfidential is IERC165, IERC6372 {
    enum ProposalState {
        Pending,
        Active,
        Canceled,
     ...
     * be consumed by UIs to show correct vote options and interpret the results.
     * The string is a URL-encoded sequence of
